...
<code><a href="https://www.github.com/itsjustshubh" target="_blank" title="Github" style="background-color: rgb(0,62,84); padding: 5px; margin: 0 5px; border-radius: 4px;">
    <strong><img src="src/assets/imported-icons/github.svg" height="30" alt="Github"> Github</strong>
    ...
    <strong><img src="src/assets/imported-icons/hackerrank-black.svg" height="30" alt="HackerRank"> HackerRank</strong>
    ...
    <strong><img src="src/assets/imported-icons/linkedin.svg" height="30" alt="Linkedin"> Linkedin</strong>
    ...
    <strong><img src="src/assets/imported-icons/instagram.svg" height="30" alt="Instagram"> Instagram</strong>
    ...
    <strong><img src="src/assets/imported-icons/apple-mail.svg" height="30" alt="iCloud Mail"> iCloud Mail</strong>
    ...
    <strong><img src="src/assets/imported-icons/devpost.svg" height="30" alt="Devpost"> Devpost</strong>
    ...
    <strong><img src="src/assets/imported-icons/medium.svg" height="30" alt="Medium"> Medium</strong>
  </a></code>
</h5>
